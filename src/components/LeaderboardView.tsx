  ...
  return (
    <div className="flex-1 flex flex-col justify-between p-1 px-1.5 md:px-2.5 md:py-1.5 text-[#1a1a1a] select-none font-mono">
      ...
      <RetroButton
        ...
        press="press"
        onClick={() => { onBack(); }}
        className="w-full min-h-[clamp(22px,4vh,30px)] border-2 border-[#1a1a1a] bg-[#e1dfde] hover:bg-neutral-300 rounded font-mono text-[8px] sm:text-[9px] font-bold flex items-center justify-center shadow-[1px_1px_0px_#1a1a1a] transition-all active:translate-y-0.5"
      >
